call compile preprocessFileLineNumbers "Common\Functions\Common_fnc_SpawnHostageRandom.sqf";
call compile preprocessFileLineNumbers "Common\Functions\Common_fnc_SpawnHostageRandomBuilding.sqf";
