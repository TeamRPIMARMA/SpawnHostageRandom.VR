...
if (CTI_POPO_SpawnRandomHostage_ENABLED isEqualTo CTI_POPO_SpawnRandomHostage_ENABLED) then {[Hostage,Random_Spawn_Hostage,CTI_POPO_SpawnRandomHostage_ENABLED] spawn POPO_fnc_SpawnRandomHostages;};
