...
if (CTI_POPO_SpawnRandomHostage_ENABLED isEqualTo CTI_POPO_SpawnRandomHostage_ENABLED) then {[Hostage,CTI_POPO_SpawnRandomHostage_ENABLED,"marker_0", 150] spawn POPO_Common_fnc_SpawnRandomHostagesBuilding;};
